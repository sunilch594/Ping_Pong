...
const storeName = window.prompt("Enter Your Name:")
const storeScore = "PPMaxScore";
const rod1Name = "Rod 1";
const rod2Name = "Rod 2";
var snd = new Audio("sound/computer-love-121106.mp3");
...
function storeWin(rod, score) {
    ...
    alert("---------------------GAME OVER"+"  "+storeName.toUpperCase()+"--------------------"+ "\nYour Score is "+ (score * 100) + ".    Max score is: " + (maxScore * 100));
